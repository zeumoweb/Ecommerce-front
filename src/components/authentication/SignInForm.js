...
const validationSchema = yup.object({
  ...
  password: yup
    ...
    .matches(
      /^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])/,
      "Should include number, lower and uppercase letter"
    )
...
const SignInForm = (props) => {
  return (
    <div
      className={`${classes["signup-right-block"]} flex justify-center items-center flex-col space-y-10`}
    >
      <div className="font-semibold text-3xl">Sign In</div>
      <Formik
      ...
      >
        <Form className="flex flex-col space-y-6">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <p className="text-xs text-red self-end">Forgot Password ?</p>
          </div>
          <div>
            <button
              type="submit"
            ...
            <div className="relative flex flex-col">
              ...
              <div className="absolute self-center text-xl p-2 px-4 bg-white">
                or
              </div>
            </div>
            <button
